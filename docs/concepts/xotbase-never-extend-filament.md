...
type: concept
module: Lang
tags: [lang, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Lang filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Lang` estende una classe `Filament\...` direttamente.
