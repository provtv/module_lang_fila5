...
created: 2026-05-04
updated: 2026-05-04
tags: [visual-testing, playwright, puppeteer, e2e, screenshot, laravel, Lang]
related:
...
I test Playwright del modulo Lang appartengono a:

```
laravel/Modules/Lang/tests/Playwright/
```
...
```javascript
// laravel/Modules/Lang/tests/Playwright/visual-regression.spec.js
import { test, expect } from '@playwright/test';

test('Lang UI renders correctly', async ({ page }) => {
    await page.goto('/it/...');
    await page.waitForLoadState('networkidle');
    await expect(page).toHaveScreenshot('Lang-initial.png', {
