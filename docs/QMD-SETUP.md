...
\`\`\`bash
qmd search "<topic>" -c lang
# Cerca solo in ./laravel/Modules/Lang/docs/wiki/
\`\`\`
...
\`\`\`bash
qmd search "form" -c lang  # Solo questo modulo
\`\`\`
...
| Ricerca lenta | Limita con `-c lang` |
